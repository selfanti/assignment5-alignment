...
from sft_helper.tokenize_prompt_and_output import tokenize_prompt_and_output as _tokenize_prompt_and_output
...
def run_compute_group_normalized_rewards(
    ...
    """
    from rl.GRPO import compute_group_normalized_rewards
...
def run_get_response_log_probs(
    ...
    """
    from sft_helper.utils import get_response_log_probs
...
def run_compute_naive_policy_gradient_loss(
    ...
    """
    from rl.GRPO import compute_naive_policy_gradient_loss
...
def run_compute_grpo_clip_loss(
    ...
    """
    from rl.GRPO import compute_grpo_clip_loss
...
def run_compute_policy_gradient_loss(
    ...
    """
    from rl.GRPO import compute_policy_gradient_loss
...
def run_masked_mean(tensor: torch.Tensor, mask: torch.Tensor, dim: int | None = None) -> torch.Tensor:
    ...
    """
    from rl.GRPO import masked_mean
...
def run_sft_microbatch_train_step(
    ...
    return sft_microbatch_train_step(
        policy_log_probs, response_mask, gradient_accumulation_steps, normalize_constant if normalize_constant is not None else 1.0
    )
...
def run_grpo_microbatch_train_step(
    ...
    """
    from rl.GRPO import grpo_microbatch_train_step
...
def run_masked_normalize(
    ...
    """
    from sft_helper.utils import masked_normalize
